...
public class Config {
    ...
    // 砀山麻游：局数选择
    public static final String CHAPTER_8 = "8";
    public static final String CHAPTER_12 = "12";
    public static final String CHAPTER_16 = "16";
    public static final String CHAPTER_24 = "24";
