...
public enum Pai {
    ...
    // 砀山麻游花牌：中、發、白（各4张，共12张）
    HUAPAI_ZHONG(PaiType.HUAPAI, 31, 10, "中"),
    HUAPAI_FA(PaiType.HUAPAI, 32, 10, "發"),
    HUAPAI_BEI(PaiType.HUAPAI, 33, 10, "白"),
    
    // 兼容旧代码：SANYUAN_ 常量指向 HUAPAI_ 常量
    SANYUAN_ZHONG(HUAPAI_ZHONG.type, HUAPAI_ZHONG.index, HUAPAI_ZHONG.dian, "中"),
    SANYUAN_FA(HUAPAI_FA.type, HUAPAI_FA.index, HUAPAI_FA.dian, "發"),
    SANYUAN_BEI(HUAPAI_BEI.type, HUAPAI_BEI.index, HUAPAI_BEI.dian, "白");
    ...
    private static final BiMap<Pai, Pai> nextMap = ImmutableBiMap.of(
            TONG_9, TONG_1, TIAO_9, TIAO_1, WAN_9, WAN_1, HUAPAI_BEI, FENG_DONG
    );
